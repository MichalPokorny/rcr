...
\texttt{chunky_png} nebo \texttt{RMagick}.
...
\item \texttt{RCR::Data::Image.load} přijímá jeden parametr, který je cesta k
	...
	\end{lstlisting}
\item \texttt{RCR::Data::Image.from_blob} umožňuje načtení obrázku přímo z
	paměti:
	% TODO: test
	\begin{lstlisting}
	...
	\end{lstlisting}
\item \texttt{RCR::Data::Image.from_pixel_array} načítá obrázek reprezentovaný
	...
	\begin{lstlisting}
		...
		array_image = RCR::Data::Image.from_pixel_array
