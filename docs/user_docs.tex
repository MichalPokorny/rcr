...
cesty \texttt{letter\_inputs\_path}. Každý podadresář obsahuje jeden "datový
blok". Data takového bloku jsou uložena v jednom obrázku ve formátu PNG,
který je uložen v podadresáři "datového bloku" pod jménem \texttt{data.png}.
